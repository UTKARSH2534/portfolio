...
export const metadata: Metadata = {
    title: 'Utkarsh Srivastava - Cloud & DevOps Engineer',
    description: 'Personal portfolio of Utkarsh Srivastava, AWS Certified Solutions Architect & Cloud/DevOps Engineer.',
};
